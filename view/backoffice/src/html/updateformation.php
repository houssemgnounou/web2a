...
// create formation
$id = $_GET['update'];
$formation = $formationC->findone($id);
if (
  isset($_POST["nom"]) &&
  ...
  if (
    ...
    $formationC->update($formation, $id);
  } else
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="card-body">
            <h5 class="card-title mt-5 fw-semibold mb-4">Modifier une formation</h5>
            <div class="mt-5 card">
              <div class="card-body">
                <form action="" id="formr" method="post">
                  <div class="mb-3">
                    <label class="form-label">Nom :</label>
                    <input type="text" value="<?= $formation['nom'] ?>" class="form-control" id="nom" name="nom">
                    <span id="nomr"></span>
                  </div>
                  <div class="mb-3">
                    <label class="form-label">Description :</label>
                    <input type="text" value="<?= $formation['description'] ?>" class="form-control" id="description" name="description">
